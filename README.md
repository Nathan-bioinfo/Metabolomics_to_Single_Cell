...
You will find the R code in the code folder: CAMERA_pipe.R file. If everything went well with the code, you chould obtain a csv file : <img src="./csv_fig.png" width="1000" height="600"> <br/>
...
<img src="./FELLA2.png" width="600" height="400"> <br/>
You can zoom in and out and rearrange label position <br/>
<img src="./FELLA3.png" width="600" height="400"> <br/>
